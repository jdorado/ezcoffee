        ...
        "actions": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "data_json": {"type": "string", "description": "A JSON object containing record fields. Updates include the current revision, e.g. {\"revision\": 3}. Creates use revision 0 or omit it. Never include id or ratio here."},
                },
